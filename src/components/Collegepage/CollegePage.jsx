          ...
          <Box style={{ textAlign: "center", color: "#F4903A" }}>
            ...
            >
              ...
              <Text style={{ textAlign: "center" }} fontSize={"1rem"}>
                {collegeData[0].location}, {collegeData[0].state}
              </Text>
            </Flex>
          </Box>
        </Box>
              ...
              >
                ...
                >
                  ...
                  <Box>
                    ...
                    <Text textAlign={"center"}>{collegeData[0].established}</Text>
                  </Box>
                </Flex>
              </Box>
              ...
              >
                ...
                >
                  ...
                  <Box>
                    ...
                    <Text textAlign={"center"}>{collegeData[0].collegetype}</Text>
                  </Box>
                </Flex>
              </Box>
              ...
              >
                ...
                >
                  ...
                  <Box>
                    ...
                    <Text textAlign={"center"}>{collegeData[0].location}</Text>
                  </Box>
                </Flex>
              </Box>
              ...
              >
                ...
                >
                  ...
                  <Box>
                    ...
                    <Text textAlign={"center"}>{collegeData[0].approval}</Text>
                  </Box>
                </Flex>
              </Box>
            </Stack>
                ...
                >
                  ...
                  <p
                    ...
                    dangerouslySetInnerHTML={{
                      __html: collegeData[0].universityDescription,
                    }}
                  ></p>
                  <table style={tableStyle}>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td style={cellStyle}>{collegeData[0].state}</td>
                      </tr>
                      <tr style={lightGreyCellStyle}>
                        <td style={boldCellStyle}>City</td>
                        <td style={cellStyle}>{collegeData[0].city}</td>
                      </tr>
                      <tr>
                        <td style={boldCellStyle}>Affiliated By</td>
                        <td style={cellStyle}>{collegeData[0].affiliatedby}</td>
                      </tr>
                      <tr style={lightGreyCellStyle}>
                        <td style={boldCellStyle}>College Category</td>
                        <td style={cellStyle}>{collegeData[0].collegecategory}</td>
                      </tr>
                    </tbody>
                  </table>
                </Box>
                  ...
                  >
                    ...
                    <table style={tableStyle}>
                      ...
                      <tbody style={{ textAlign: "center" }}>
                        {collegeData[0].courses?.map((course, index) => (
                          <tr
                            key={index}
                            style={{
                              backgroundColor:
